...
export function TopBar() {
  return (
    <>
      ...
      <div className="h-[5px] sm:h-[7px]"></div>
      <div className="bg-black min-h-[40px] sm:h-[45px] relative py-1 sm:py-0">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-5 h-full flex items-center justify-between">
          <Link prefetch href="/" className="font-amiri text-[30px] sm:text-[40px] leading-none text-white tracking-tight hover:text-paper transition-colors">
            kmlri
          </Link>
