    ...
    <footer className="bg-black text-white font-amiri">
      <div className="max-w-[1100px] mx-auto pt-10 sm:pt-[65px] px-4 sm:px-5 grid grid-cols-1 md:grid-cols-[374px_1fr_1fr] gap-8 sm:gap-12">
        ...
        <div className="border-t border-gray-800 md:border-t-0 pt-6 md:pt-0">
          ...
          <div className="flex flex-col gap-2.5 sm:gap-[11px] text-[16px] sm:text-[17px]">
            <Link prefetch href="/collections" className="text-white hover:text-paper">Collections</Link>
            <Link prefetch href="/search" className="text-white hover:text-paper">Digital reading room</Link>
            <Link prefetch href="/advanced" className="text-white hover:text-paper">Advanced search</Link>
            <Link prefetch href="/news" className="text-white hover:text-paper">New acquisitions</Link>
            <Link prefetch href="/stories" className="text-white hover:text-paper">Stories</Link>
            <Link prefetch href="/opportunities" className="text-white hover:text-paper">Opportunities</Link>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 md:border-t-0 pt-6 md:pt-0">
          ...
          <div className="flex flex-col gap-2.5 sm:gap-[11px] text-[16px] sm:text-[17px]">
            <Link prefetch href="/services" className="text-white hover:text-paper">Reading room</Link>
            <Link prefetch href="/signup" className="text-white hover:text-paper">Membership</Link>
            <Link prefetch href="/ask" className="text-white hover:text-paper">Ask a librarian</Link>
            <Link prefetch href="/services" className="text-white hover:text-paper">Reproduction requests</Link>
            <Link prefetch href="/faqs" className="text-white hover:text-paper">FAQs</Link>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1100px] mx-auto mt-8 sm:mt-11 px-4 sm:px-5 py-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-[12px] text-white border-t border-[#1F1F1F] text-center sm:text-left">
        ...
        <span className="flex gap-4 sm:gap-5">
          <Link prefetch href="/about" className="text-[#9C9C9C] hover:text-white">Privacy</Link>
          <Link prefetch href="/about" className="text-[#9C9C9C] hover:text-white">Terms of use</Link>
          <Link prefetch href="/about" className="text-[#9C9C9C] hover:text-white">Accessibility</Link>
        </span>
      </div>
    </footer>
  );
